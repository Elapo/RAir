...
public abstract class PersistenceTest extends Assert {
     ...
     * Default lets {@link com.realdolmen.rair.util.persistence.PersistenceTest.DatabaseEngine#current()} choose.
     ...
     * Note this connection does not participate in the same transaction as the {@link com.realdolmen.rair.util.persistence.JpaPersistenceTest#entityManager()}, so be careful
